package writhingmasscharactermod.cards;
...
import writhingmasscharactermod.util.TriFunction;
...
import static writhingmasscharactermod.util.GeneralUtils.removePrefix;
import static writhingmasscharactermod.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return WrithingMassCharacterMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    WrithingMassCharacterMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
